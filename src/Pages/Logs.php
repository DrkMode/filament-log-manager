...
namespace DrkMode\FilamentLogManager\Pages;

use Exception;
use Filament\Forms\Components\Select;
use Filament\Pages\Page;
use DrkMode\FilamentLogManager\LogViewer;
...
class Logs extends Page
{
    ...
    {
        return config('filament-log-manager.label');
    }

    protected function getTitle(): string
    {
        return config('filament-log-manager.title');
    }

    protected static function getNavigationGroup(): ?string
    {
        return config('filament-log-manager.navigation_group');
    }
}
